export const Footer = () => {
    const socialLinks = [
      {
        name: 'Instagram',
        url: 'https://www.instagram.com/imprakharr/',
        icon: (
      ...
      {
        name: 'LinkedIn',
        url: 'https://www.linkedin.com/in/prakharsaxena5',
        icon: (
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/Luciferr5',
        icon: (
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      {
        name: 'Email',
        url: 'mailto:prakharsaxena5@outlook.com',
        icon: (
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="text-gray-400 text-sm">
              © 2025 Created by Prakhar Saxena.
            </div>
